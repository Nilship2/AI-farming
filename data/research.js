...
DataRegistry.registerAll("research", [
    {id:"compost",      n:"谷物堆肥", i:"🌾♻️", desc:"消耗小麦制作堆肥，解锁堆肥升级",      cost:{wheat:1000},                    unlocks:[{type:"upgrade",id:"compostUpg"}]},
    {id:"cropRotate",   n:"轮作制度", i:"🔄",   desc:"研究轮作提高产量，解锁轮作升级",      cost:{wheat:500, carrot:500},         unlocks:[{type:"upgrade",id:"cropRotateUpg"}], requires:["compost"]},
    ...
    {id:"deepPlow",     n:"深耕技术", i:"⛏️",   desc:"深耕土地提升产量，获得补偿种子",      cost:{potato:2000},                   unlocks:[{type:"upgrade",id:"deepPlowUpg"},{type:"resource",k:"seeds",q:50}]},
    {id:"ghOptimize",   n:"温室优化", i:"🏠⚡", desc:"优化温室效率，额外提升生长速度",      cost:{tomato:500, corn:500},          unlocks:[{type:"upgrade",id:"ghOptimizeUpg"}], requires:["deepPlow"]},
    {id:"animalGene",   n:"动物基因", i:"🧪🐔", desc:"基因改良，动物产物+1",               cost:{egg:50},                        unlocks:[{type:"upgrade",id:"animalGeneUpg"}], requires:["feedScience"]},
    {id:"harvestTech",  n:"收获工艺", i:"🚜",   desc:"改进收获技术，所有作物收获量+1",      cost:{corn:1000, potato:500, wheat:500}, unlocks:[{type:"upgrade",id:"harvestTechUpg"}]},
