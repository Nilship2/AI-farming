...
var HYBRID_DEFS={"carrot_pumpkin":{n:"金色胡萝卜",i:"✨🥕",p:["carrot","pumpkin"],ch:0.15,v:120,g:280,soil:"dark",unlock:50000},"corn_blueberry":{n:"紫玉米",i:"💜🌽",p:["corn","blueberry"],ch:0.12,v:100,g:240,soil:"dark",unlock:60000},"tomato_pepper":{n:"火焰番茄",i:"🔥🍅",p:["tomato","pepper"],ch:0.1,v:90,g:200,soil:"sand",unlock:45000},"wheat_sunflower":{n:"金穗麦",i:"🌟🌾",p:["wheat","sunflower"],ch:0.08,v:150,g:180,soil:null,unlock:100000},"strawberry_grape":{n:"宝石莓",i:"💎🍓",p:["strawberry","grape"],ch:0.06,v:200,g:300,soil:"clay",unlock:150000},"watermelon_pumpkin":{n:"巨无霸瓜",i:"🏆🎃",p:["watermelon","pumpkin"],ch:0.05,v:300,g:360,soil:"sand",unlock:250000}};
...
var allW=[{k:"sunny",n:"晴天",i:"☀️",d:"生长加速+10%"},{k:"cloudy",n:"多云",i:"☁️",d:"无加成"},{k:"rainy",n:"雨天",i:"🌧️",d:"生长加速+30%"},{k:"storm",n:"暴风雨",i:"⛈️",d:"生长速度-40%"}];
...
function buyGemUpgrade(gid){var gd=GEM_UPG_DEFS[gid];if(!gd)return;if(GS.gemUpgrades[gid])return;if(gd.req&&!GS.gemUpgrades[gd.req]){notify('需要先购买'+GEM_UPG_DEFS[gd.req].n);return;}var price=gd.c;if(gd.repeatable)price=gd.c+(GS.extraLand||0)*gd.costGrowth;if(GS.gems<price){notify('宝石不足！');return;}GS.gems-=price;GS.gemUpgrades[gid]=true;if(gd.repeatable){GS.gemUpgrades[gid]=false;GS.extraLand=(GS.extraLand||0)+1;GS.maxLand=20+Math.floor((GS.prestigePoints||0)/2)+(GS.extraLand||0);while(GS.land.length<GS.maxLand){var soils2=["normal","clay","sand","dark"];GS.land.push({id:GS.land.length,unlocked:false,soil:soils2[GS.land.length%4]});}}notify('💎 已购买: '+gd.n);renderPrestige();R();saveGame();}function sellItem(k,q){
...
if(!GS.discoveredHybrids)GS.discoveredHybrids=[];if(!GS.gemUpgrades)GS.gemUpgrades={};if(!GS.totalGemsEarned)GS.totalGemsEarned=0;if(!GS.extraLand)GS.extraLand=0;
