...
function gameLoop(){
var now=Date.now();var dt=(now-lastTick)/1000;if(dt>5)dt=5;if(GS.gemUpgrades&&GS.gemUpgrades.timeHourglass&&document.hidden)dt*=1.5;lastTick=now;if(dt>5)dt=5;if(dt>5)dt=5;
tick(dt);
_renderInterval+=dt;
