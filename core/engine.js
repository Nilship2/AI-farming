...
// 旧代码无需修改即可运行。数据定义位于 data/*.js
// ============================================================
var CROP_DEFS = DataRegistry.dump("crop");
var HYBRID_DEFS = DataRegistry.dump("hybrid");
var ANIMAL_DEFS = DataRegistry.dump("animal");
var PROC_DEFS = DataRegistry.dump("processor");
var UPG_DEFS = DataRegistry.dump("upgrade");
var RELIC_DEFS = DataRegistry.dump("relic");
var GEM_UPG_DEFS = DataRegistry.dump("gemUpgrade");
var STORIES = DataRegistry.dump("story");
...
var allW = DataRegistry.all("weather");
var allEv = DataRegistry.all("event");
var ACH_DEFS = DataRegistry.all("achievement");
// ============================================================
